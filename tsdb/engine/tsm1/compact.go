...
type Compactor struct {
	...
	// Returns the filename used for files generated by CompactFast().
	CompactFastFormatFileName FormatFileNameFunc
...
func (c *Compactor) compact(fast bool, tsmFiles []string) ([]string, error) {
	...
	return c.writeNewFiles(maxGeneration, maxSequence, tsmFiles, tsm, true, c.CompactFastFormatFileName)
}
...
func (c *Compactor) writeNewFiles(generation, sequence int, src []string, iter KeyIterator, throttle bool, formatFileName FormatFileNameFunc) ([]string, error) {
	...
	for {
		...
		fileName := filepath.Join(c.Dir, formatFileName(generation, sequence, src)+"."+TSMFileExtension+"."+TmpTSMFileExtension)
